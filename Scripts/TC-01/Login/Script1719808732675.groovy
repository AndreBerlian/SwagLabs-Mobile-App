...
Mobile.setText(findTestObject('Page_Login/input_Username'), 'bob@example.com', 0)

Mobile.setEncryptedText(findTestObject('Page_Login/input_Password'), 'dbXIBZ66cuht4KTRMDozZw==', 0)
